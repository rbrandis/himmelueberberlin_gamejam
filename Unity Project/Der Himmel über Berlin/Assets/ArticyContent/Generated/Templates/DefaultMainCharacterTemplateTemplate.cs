...
namespace Articy.Der_Himmel_Ueber_Berlin.Templates
{
    ...
    public class DefaultMainCharacterTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy.Der_Himmel_Ueber_Berlin.Features.DefaultExtendedCharacterFeatureFeature DefaultExtendedCharacterFeature
        {
            get
            {
        ...
        {
            Articy.Der_Himmel_Ueber_Berlin.Templates.DefaultMainCharacterTemplateTemplate newClone = ((Articy.Der_Himmel_Ueber_Berlin.Templates.DefaultMainCharacterTemplateTemplate)(aClone));
            if ((DefaultExtendedCharacterFeature != null))
            {
                newClone.DefaultExtendedCharacterFeature = ((Articy.Der_Himmel_Ueber_Berlin.Features.DefaultExtendedCharacterFeatureFeature)(DefaultExtendedCharacterFeature.CloneObject()));
            }
        ...
        {
            Articy.Der_Himmel_Ueber_Berlin.Templates.DefaultMainCharacterTemplateTemplate clone = new Articy.Der_Himmel_Ueber_Berlin.Templates.DefaultMainCharacterTemplateTemplate();
